...
void drawRectDMA(int row, int col, int width, int height, volatile u16 color) {
  ...
  //   DMA[DMA_CHANNEL_0].src = &color;
  //   DMA[DMA_CHANNEL_0].dst = &videoBuffer[OFFSET(row + y, col, WIDTH)];
  //   DMA[DMA_CHANNEL_0].cnt = width | DMA_DESTINATION_INCREMENT | DMA_SOURCE_FIXED | DMA_16 | DMA_NOW;
